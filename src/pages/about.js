...
const qAndA = {
  ...
  "Why does this site look so nice?": `This site was made with the help of ${makeLink('styled-components.com', 'styled-components')} and ${makeLink('material-ui.com/style/icons/', 'Material Icons')}!`
}
